  ...
  tabsetPanel(type = "tabs",
              ...
              tabPanel("CIMERLSPI",
                       ...
                       selectInput("prodcimerlspi_q", "Select a figure:",
                                   ...
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plotcimerlspi_q", height = 650),
                       br(),
                       plotlyOutput("percentcimerlspi_q", height = 650),
                       br(),
                       plotlyOutput("yearpercentcimerlspi_q", height = 650),
                       br()
              ),
              tabPanel("CMSPI",
                       br(),
              ...
              tabPanel("CRSPI",
                       ...
                       selectInput("prodcrspi_q", "Select a figure:",
                                   ...
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plotcrspi_q", height = 650),
                       br(),
                       plotlyOutput("percentcrspi_q", height = 650),
                       br(),
                       plotlyOutput("yearpercentcrspi_q", height = 650),
                       br()
              ),
              ...
              tabPanel("FHMCFSPI",
                       ...
                       selectInput("prodf_q", "Select a figure:",
                                   ...
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plotf_q", height = 650),
                       br(),
                       plotlyOutput("percentf_q", height = 650),
                       br(),
                       plotlyOutput("yearpercentf_q", height = 650),
                       br()
              ),
              ...
              tabPanel("NLSPI",
                       ...
                       selectInput("prodnlspi_q", "Select a figure:",
                                   ...
                                   selected = "Canada (Business)",
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plotnlspi_q", height = 650),
                       br(),
                       plotlyOutput("percentnlspi_q", height = 650),
                       br(),
                       plotlyOutput("yearpercentnlspi_q", height = 650),
                       br()
              ),
              ...
              tabPanel("RSPI",
                       ...
                       selectInput("prodrspi_q", "Select a figure:",
                                   ...
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plotrspi_q", height = 650),
                       br(),
                       plotlyOutput("percentrspi_q", height = 650),
                       br(),
                       plotlyOutput("yearpercentrspi_q", height = 650),
                       br()
              ),
              ...
              tabPanel("TASPI",
                       ...
                       selectInput("prodtaspi_q", "Select a figure:",
                                   ...
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plottaspi_q", height = 650),
                       br(),
                       plotlyOutput("percenttaspi_q", height = 650),
                       br(),
                       plotlyOutput("yearpercenttaspi_q", height = 650),
                       br()
              ),
              ...
              tabPanel("WSPI",
                       ...
                       selectInput("prodwspi_q", "Select a figure:",
                                   ...
                                   multiple = TRUE, 
                                   width = "100%"),
                       plotlyOutput("plotwspi_q", height = 650),
                       br(),
                       plotlyOutput("percentwspi_q", height = 650),
                       br(),
                       plotlyOutput("yearpercentwspi_q", height = 650),
                       br()
              ),
